...
public class LecturaCliente {
    public static Cliente lecturaCliente(){
        ...
        Titulo.Mensaje("DATOS DEL CLIENTE");
        String nombres = lecturaDatos.lecturaString("", "Nombre: ");
        String apellidoPaterno = lecturaDatos.lecturaString("", "Apellido Paterno: ");
        String apellidoMaterno = lecturaDatos.lecturaString("", "Apellido Materno: ");
        String DNI = lecturaDatos.lecturaString("", "DNI: ");
